...
import (
	...
	"open-cluster-management.io/managed-rbac/controllers"
...
func init() {
	...
	utilruntime.Must(mrbacv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:        "managed-rbac-leader.open-cluster-management.io",
	...
	if err = (&controllers.ManagedRBACReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "ManagedRBAC")
		os.Exit(1)
	}
