...
// ManagedRBACSpec defines the desired state of ManagedRBAC
type ManagedRBACSpec struct {
...
type ClusterRoleBinding struct {
	// Subject contains a reference to the object or user identities a ManagedRBAC binding applies to.
...
// ManagedRBACStatus defines the observed state of ManagedRBAC
type ManagedRBACStatus struct {
...
// ManagedRBAC is the Schema for the managedrbacs API
type ManagedRBAC struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   ManagedRBACSpec   `json:"spec,omitempty"`
	Status ManagedRBACStatus `json:"status,omitempty"`
}

//+kubebuilder:object:root=true

// ManagedRBACList contains a list of ManagedRBAC
type ManagedRBACList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ManagedRBAC `json:"items"`
}

func init() {
	SchemeBuilder.Register(&ManagedRBAC{}, &ManagedRBACList{})
}
